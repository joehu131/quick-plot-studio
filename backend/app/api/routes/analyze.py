...
def analyze_dataset(payload: AnalyzeRequest):
    """Analyzes a cached dataset with Gemini 2.5 Flash and returns recommended ChartSpec JSON."""
    ...
    # 2. Invoke Gemini AI (or heuristic fallback if API key unconfigured/failing)
    raw_spec = ai_service.analyze_dataset(summary)
